...
class TestJsonResolver:
    def test_get_ip_success(self, json_resolver_config):
        mock_response = Mock()
    ...
    def test_get_ip_missing_field(self, json_resolver_config):
        mock_response = Mock()
        mock_response.status_code = 200
    ...
    def test_get_ip_invalid_ip_format(self, json_resolver_config):
        mock_response = Mock()
        mock_response.status_code = 200
    ...
    def test_get_ip_http_error(self, json_resolver_config):
        with patch(
            "dnswatch.resolvers.json.json_resolver.requests.get",
    ...
    def test_get_ip_ipv6(self, json_resolver_config):
        mock_response = Mock()
        mock_response.status_code = 200
